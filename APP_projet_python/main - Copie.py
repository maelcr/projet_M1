...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.degree_variable = tkinter.StringVar(value=self.lire_fichier_txt("degree"))
        self.detection_cam_variable = tkinter.StringVar(value="NON")
        ...
        self.label_titre1 = customtkinter.CTkLabel(self.tab_cam,text= "Detection CAMERA:")
        ...
        self.checkbox_apply("sauveguarde_checkbox_chauffage")
    ...
    def checkbox_chauffage_ecriture(self):
        ...
        if (self.check_var.get() == "on"):
            self.ecrire_fichier_txt("sauveguarde_checkbox_chauffage","1")
        elif (self.check_var.get() == "off"):
            self.ecrire_fichier_txt("sauveguarde_checkbox_chauffage","0")
    ...
    def reinit_variable(self):
        #degree_enclot
        i = self.lire_fichier_txt("degree") + " degrée"
    ...
    def check_etat_enclot(self):
        #etat enclot
        etat = self.lire_fichier_txt("etat_de_lenclot")
        if (etat == "0"):
    ...
    def reponse_vue(self):
        self.ecrire_fichier_txt("etat_de_lenclot","0")
        self.etat_enclot_variable.set(self.check_etat_enclot())
    ...
    def ecrire_fichier_txt (self,file_name,message):
        with open("save/" + file_name + ".txt","w") as f:
            f.write(message)
